...
<head>
    ...
    <title>Create Blog - Resort Admin Panel</title>
...
<body>
    <div class="admin-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="header">
                <h1><i class="fas fa-plus-circle"></i> Create New Blog</h1>
                <div style="display:flex; align-items:center; gap: 12px;">
                    <a href="builder.php" class="btn btn-primary" style="background:linear-gradient(135deg,#5DC5E3 0%,#1D285C 100%); border:1px solid rgba(93,197,227,0.4);"><i class="fas fa-magic"></i> Live Preview Builder</a>
                    <div class="user-info">
            ...
            <div class="form-container">
                <form method="POST" enctype="multipart/form-data" id="blogForm">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="excerpt" placeholder="Short summary of your blog" maxlength="500" rows="3"><?php echo htmlspecialchars($_POST['excerpt'] ?? ''); ?></textarea>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="category_custom" id="categoryCustom" placeholder="Enter custom category" style="margin-top: 10px; display: none;">
                        </div>
                        
                        <div class="form-group">
                            <label><i class="fas fa-user"></i> Author</label>
                            <input type="text" name="author" value="<?php echo htmlspecialchars($_POST['author'] ?? ($_SESSION['admin_name'] ?? 'Admin')); ?>" maxlength="100">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small style="color:var(--text-muted);display:block;margin-top:4px;">Max size: 5MB. Allowed: JPG, PNG, GIF, WEBP</small>
